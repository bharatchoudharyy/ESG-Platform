...
interface DataCardProps {
    ...
    categoryColor?: 'border-l-green-500' | 'border-l-blue-500' | 'border-l-purple-500' | 'border-l-yellow-500' | 'border-l-gray-500';
}
const DataCard: React.FC<DataCardProps> = ({
    label,
    value,
    unit = '',
    // --- 2. Default category color ---
    categoryColor = 'border-l-gray-500',
}) => {
